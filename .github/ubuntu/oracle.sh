...
bsdtar -C /usr/local/lib --strip-components 1 -zxf "instantclient-basic-linux.x64-${version}.zip"
bsdtar -C /usr/local/lib --strip-components 1 -zxf "instantclient-sqlplus-linux.x64-${version}.zip"
bsdtar -C /usr/local/lib --strip-components 1 -zxf "instantclient-sdk-linux.x64-${version}.zip"
