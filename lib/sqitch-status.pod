...
and may also be specified as the C<--database> option. It can be either a URI
or the name of a database in the configuration.
...
The database to which to connect. This option can be either a URI or the name
of a database in the configuration.
