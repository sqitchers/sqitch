...
Vertica's
L<C<vsql> variables|http://my.vertica.com/docs/7.1.x/HTML/index.htm#Authoring/ProgrammersGuide/vsql/Variables.htm>,
and SQL*Plus's
...
executing the revert shoud be "yes" or "no". The C<checkout.prompt_accept>
