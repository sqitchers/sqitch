...
C<--revert-dir>, and C<--verify-dir> directories. The content of these files
is determined by the evaluation of templates. By default, system templates in
...
where, exactly. Individual templates may be overridden on a user basis by
