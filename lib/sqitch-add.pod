...
To specify which plans an top directories to which the change and its scripts
...
Sqitch defines four variables for all templates. Any number of additional
...
C<sqlite>, C<mysql>, C<oracle>, C<firebird>, or C<vertica>.
