...
=item C<oneline>
  ...
  <change id> <event type> <change name> <title line>
...
=item * C<%R>: Parenthesized list of comma-delimited required changes

=item * C<%{$sep}R>: Parenthesized list of required changes delimited by C<$sep>

=item * C<%x>: Comma-delimited list of conflicting changes

=item * C<%{$sep}x>: list of conflicting changes delimited by C<$sep>

=item * C<%X>: Parenthesized list of comma-delimited conflicting changes

=item * C<%{$sep}X>: Parenthesized list of conflicting changes delimited by C<$sep>
