...
=item * C<%{1}e>: ANSI-colored Event type (green deploy, blue revert, red fail)

=item * C<%l>: Localized lowercase event type label

=item * C<%{1}l>: Localized and ANSI-colored lowercase event type label

=item * C<%L>: Localized title case event type label

=item * C<%{1L>: Localized and ANSI-colored title case event type label
