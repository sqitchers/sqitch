...
=item * C<top_dir> sets C<core.top_dir>

=item * C<plan_file> sets C<core.plan_file>

=item * C<engine> sets C<core.engine>

=item * C<deploy_dir> sets C<core.deploy_dir>

=item * C<revert_dir> sets C<core.revert_dir>

=item * C<verify_dir> sets C<core.verify_dir>

=item * C<reworked_dir> sets C<core.reworked_dir>

=item * C<reworked_deplpoy_dir> sets C<core.reworked_deploy_dir>

=item * C<reworked_deplpoy_dir> sets C<core.reworked_revert_dir>

=item * C<reworked_deplpoy_dir> sets C<core.reworked_verify_dir>

=item * C<extension> sets C<core.extrension>

=item * C<registry> sets C<engine.$engine.registry>

=item * C<client> sets C<engine.$engine.client>

=item * C<target> sets C<engine.$engine.target> and, if it's a target name, C<target.$target.uri>
