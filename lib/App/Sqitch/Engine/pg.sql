...
COMMENT ON COLUMN :"sqitch_schema".changes.comment         IS 'Description of the change.';
...
COMMENT ON COLUMN :"sqitch_schema".tags.comment         IS 'Description of the tag.';
...
COMMENT ON COLUMN :"sqitch_schema".events.comment         IS 'Description of the change.';
