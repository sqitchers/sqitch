...
=item C<< <step>@<tag> >>, e.g, C<users_table@beta>

A step as of the specified tag. Probably more useful, in general, just to
deploy to the tag.
...
Special symbolic name for the first step in the plan. Typically omitted.
