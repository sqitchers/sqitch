...
=item C<core.sqlite.db_uri>

SQLite database connection URI.

=item C<core.sqlite.sqitch_db_uri>
...
=item C<core.oracle.db_uri>

Oracle database connection URI.
