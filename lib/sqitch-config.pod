...
other data should be stored in this database. If you want all of your
Sqitch-managed MySQL databases to use a single Sqitch database, set
C<core.mysql.sqitch_db> to the common database, perhaps C<sqitch>. Defaults to
the the value of C<$db_name> with C<_sqitch> appended to the end.
