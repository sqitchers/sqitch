...
For writing options: write to system-wide F<$(prefix)/etc/sqitch/sqitch.plan>
file rather than the repository F<./sqitch.conf>.

For reading options: read only from system-wide
F<$(prefix)/etc/sqitch/sqitch.plan> file rather than from all available files.
...
=item F<$(prefix)/etc/sqitch/sqitch.plan>
