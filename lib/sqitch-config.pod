...
=item C<core.pg.database>

PostgreSQL database key or connection URI.

=item C<core.pg.registry>

The name of the Sqitch registry schema. Sqitch will store its metadata in this
...
=item C<core.sqlite.database>

SQLite database key or connection URI.

=item C<core.sqlite.registry>

Name to use for the Sqitch registry database. Sqitch will store its metadata
...
=item C<core.mysql.database>

MySQL database key or connection URI.

=item C<core.mysql.registry>

The name of the Sqitch registry database. Sqitch will store its metadata in
...
=item C<core.oracle.database>

Oracle database key or connection URI.
