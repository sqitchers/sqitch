...
=head1 Synopsis
  ...
  sqitch [options] rebase --onto-change <change>
  sqitch [options] rebase --onto-change <change> --upto-change <change>
  sqitch [options] rebase <change>
  sqitch [options] rebase <change> --upto-change <change>
  sqitch [options] rebase <change> <change>
